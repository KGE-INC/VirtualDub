...
public:
	...
	void Encode(std::vector<char>& dst, const char *src, ptrdiff_t srcpitch, int format, int w, int h);
...
protected:
	...
	std::vector<uint32>	mCoefficientHeap;
	std::vector<char> *mpDst;
...
void VDJPEGEncoder::Init(int q, bool bOptimizeHuffmanTables, eChromaMode cmode) {
	...
	for(i=0; i<256; ++i) {
		sint32 r_y	= (sint32)((0x00880000 + i * 0x4c8b44) & 0xfff00000);
		sint32 g_y	= (sint32)((0x00080000 + i * 0x9645a2) & 0xfff00000);
		sint32 b_y	= (sint32)((0x00080000 + i * 0x1d2f1a) & 0xfff00000);
		sint32 r_cb	= (sint32)((0x00080a00 - i * 0x0002b3) & 0xfffffc00);
		sint32 g_cb	= (sint32)((0x00000200 - i * 0x00054d) & 0xfffffc00);
		sint32 b_cb	= (sint32)((0x00000200 + i * 0x000800) & 0xfffffc00);
		sint32 r_cr	=((sint32)((0x00080a00 + i * 0x000800) & 0xfffffc00) >> 10);
		sint32 g_cr	=((sint32)((0x00000200 - i * 0x0006b3) & 0xfffffc00) >> 10);
		sint32 b_cr	=((sint32)((0x00000200 - i * 0x00014d) & 0xfffffc00) >> 10);
...
void VDJPEGEncoder::Encode(std::vector<char>& dst, const char *src, ptrdiff_t srcpitch, int format, int w, int h) {
	mpDst = &dst;
	...
	for(int y=0; y<mcu_vert_count; ++y) {
		...
		for(int x=0; x<mcu_horiz_count; ++x) {
			...
			case kYCC444:
				fdct(dct_coeff[0], ysrc, mStripWidth);
				fdct(dct_coeff[4], cbsrc, mStripWidth);
				fdct(dct_coeff[5], crsrc, mStripWidth);
				ysrc += 8;
				break;
			}
