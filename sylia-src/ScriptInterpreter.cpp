...
public:
	...
	char *TranslateScriptError(CScriptError& cse);
...
__declspec(dllexport) IScriptInterpreter * __stdcall CreateScriptInterpreter() {
...
char *CScriptInterpreter::TranslateScriptError(CScriptError& cse) {
	char *s;
	int i;
