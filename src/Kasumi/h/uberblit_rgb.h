...
class VDPixmapGen_B8x3_To_G8R8_G8B8 : public VDPixmapGenWindowBased {
public:
...
class VDPixmapGen_B8x3_To_R8G8_B8G8 : public VDPixmapGenWindowBased {
public:
	void Init(IVDPixmapGen *srcCr, uint32 srcindexCr, IVDPixmapGen *srcY, uint32 srcindexY, IVDPixmapGen *srcCb, uint32 srcindexCb) {
		mpSrcY = srcY;
		mSrcIndexY = srcindexY;
