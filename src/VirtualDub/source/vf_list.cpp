...
const VDPluginInfo *const g_VDInternalVideoPlugins[]={
	&vpluginDef_input,
	&vpluginDef_IVTC,
	&vpluginDef_separateFields,
	&vpluginDef_WeaveFields,
	NULL
};

void VDInitBuiltinVideoFilters() {
	VDAddInternalPlugins(g_VDInternalVideoPlugins);
}
