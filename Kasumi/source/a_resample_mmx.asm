...
;
_vdasm_resize_interp_row_run_MMX	proc near public
	push	ebp
	push	edi
	push	esi
	push	ebx
...
@colloop:
	...
	pop		ebp
	ret
_vdasm_resize_interp_row_run_MMX	endp
...
_vdasm_resize_interp_col_run_MMX	proc near public
	push	ebp
	push	edi
	push	esi
	push	ebx
...
@colloop:
	...
	pop		ebp
	ret
_vdasm_resize_interp_col_run_MMX	endp


;--------------------------------------------------------------------------
;vdasm_resize_ccint_row_MMX(dst, src, count, xaccum, xinc, tbl);

_vdasm_resize_ccint_row_MMX		proc	near public
	push	ebx
	push	esi
	push	edi
	push	ebp
...
ccint_loop_MMX_start:
	...
	pop		ebx
	ret
_vdasm_resize_ccint_row_MMX		endp

;--------------------------------------------------------------------------
;vdasm_resize_ccint_col_MMX(dst, src1, src2, src3, src4, count, tbl);

_vdasm_resize_ccint_col_MMX	proc near public
	push	ebx
	push	esi
	push	edi
	push	ebp
...
ccint_col_loop_MMX@entry:	
	...
	pop		ebx
	ret
_vdasm_resize_ccint_col_MMX	endp	

;--------------------------------------------------------------------------
;vdasm_resize_ccint_col_SSE2(dst, src1, src2, src3, src4, count, tbl);

_vdasm_resize_ccint_col_SSE2	proc near public
	push	ebx
	push	esi
	push	edi
	push	ebp
...
ccint_col_SSE2_noodd:
	...
	pop		ebx
	ret
_vdasm_resize_ccint_col_SSE2	endp
...
_vdasm_resize_table_row_MMX	proc	near
	push	ebp
	push	esi
	push	edi
	push	ebx
...
_vdasm_resize_table_row_MMX	endp
...
_vdasm_resize_table_col_MMX	proc	near
	push		ebp
	push		esi
	push		edi
	push		ebx
...
_vdasm_resize_table_col_MMX	endp

_vdasm_resize_table_col_SSE2	proc	near
	push		ebp
	push		esi
	push		edi
	push		ebx
...
_vdasm_resize_table_col_SSE2	endp
